"""
Copyright (c) 2021-2023 AHM7D-SB
 (AHM7D.SB@gmail.com)
...
while True:
    ...
    print("\033[91m    ////////// _  _(/\033[0m  \033[95m ////////////////___  /     \033[0m     /  ______// ")
    print("\033[91m ) /   \\__(/_(_(_\033[0m\033[95m  _/___  /     \033[0m   ) /  (_)(_)(/_")
    print("\033[91m(_/\033[0m              \033[95m(_/___ /  (_/___ /    (_/      \033[0m  (_/\n")
    print("                        Author: Mr.\033[AHM7D\033[0m")
    print("       Github: https://github.com/Jokergazaa/RDDoS_Tool")
